  ...
  <div>
    <div class="player-container">
      <div>
        ...
        <div>
          <img class="small-image" v-if="player1Choice === 'Rock'" src="./assets/rk_L.png"   alt="ค้อน" />
          <img class="small-image" v-if="player1Choice === 'Paper'" src="./assets/pp_L.png" alt="กระดาษ" />
          <img class="small-image" v-if="player1Choice === 'Scissors'" src="./assets/sc_L.png" alt="กรรไกร" />
        </div>
        <div>
      ...
      <div>
        ...
        <div>
          <img class="small-image" v-if="player2Choice === 'Rock'" src="./assets/rk_R.png" alt="ค้อน" />
          <img class="small-image" v-if="player2Choice === 'Paper'" src="./assets/pp_R.png" alt="กระดาษ" />
          <img class="small-image" v-if="player2Choice === 'Scissors'" src="./assets/sc_R.png" alt="กรรไกร" />
        </div>
        <div>
